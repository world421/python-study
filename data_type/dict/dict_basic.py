...
'''
studnets = { '멍멍이':'홍길동', '야옹이':'박영희','짹짹이':'김철수'}
...
print(studnets['멍멍이'])
print(studnets['짹짹이'])
# print(studnets['메뚜기']) # 없는 값을 주면 error

# in 키워드를 사용하여 key의 존재유무를 파악할 수 있습니다.
print('멍멍이' in studnets) #True
print('메뚜기' not in studnets) #True