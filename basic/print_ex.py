...
# print(dog, cat, '좋아용!!' sep=' ' ) -> 기본값 
#print(dog, cat, '좋아용~, sep='')
print(dog, cat, '좋아용~', sep=' !!!')
...
'''
# print(dog, cat, '좋아용!!', end='/n') =- > 기본값
print(dog, cat, '좋아용~', end='!!!')
print('이 문장에는 줄 개행이 되어서 나올까요??')

# 출력할 내용이 먼저 전달되어야 합니다.
print(dog, cat, '좋아용~', end='', sep='=>')
#print(end='', sep='=>'dog, cat, '좋아용~')(x) 
print('메롱 ~ ')
